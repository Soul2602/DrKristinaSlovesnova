...
function AboutMeSection() {
  ...
  const texts = useMemo(() => {
    return [
      "Решение о выборе специальности было предсказано с пеленок. Как и полагается дочери стоматологов в 4 поколении, все детство я проводила в стоматологических клиниках.",
      "В 2015 году, с целью практики языка и более глубокого осваивании предметов, изучала Биологию, Химию и Математику в Великобритании-Wycliffe college, Stonehouse, Gloucesterhire на курсе Year 12.",
